          ...
          <div className="row mt-3">
            <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
              ...
              <p>
                ...
                high-quality products to meet all your needs and provide a
                seamless shopping experience from the comfort of your own home.
              </p>
            </div>
            ...
            <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
              ...
              />
              <p>
                <i className="fas fa-home mr-3"></i> HYD, IN 123456
              </p>
              <p>
                <i className="fas fa-envelope mr-3"></i> info@kartify.com
              </p>
              <p>
